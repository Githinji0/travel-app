...
const AboutUs = () => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 text-white px-5 h-full items-center">
      <div className="h-full flex flex-col justify-center gap-5">
        ...
        <p className=" text-gray-800 text-sm lg:text-base max-w-md lg:max-w-lg">
