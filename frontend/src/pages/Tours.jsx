              ...
              >
                <Link to={`/destinations/${it.id}`} className="block group">
                  ...
                  <div className="p-4">
                    ...
                    <button onClick={()=>handleNavigate(it.id)} type="button" className="mt-2 bg-pink-600 hover:underline p-3 rounded-sm text-white text-sm">
                      View Details
                    </button>
                  </div>
                </Link>
